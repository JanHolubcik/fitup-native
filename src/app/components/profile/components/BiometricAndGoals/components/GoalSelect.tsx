...
const GOAL_OPTIONS = [
  { value: "loseWeight", labelKey: "loseFat" },
  { value: "maintainWeight", labelKey: "maintainWeight" },
  { value: "gainWeight", labelKey: "buildMuscle" },
] as const;
...
const GoalSelect = () => {
  ...
  const selectedGoal = goalOptions.find((opt) => opt.value === values.goal) || goalOptions[0];
